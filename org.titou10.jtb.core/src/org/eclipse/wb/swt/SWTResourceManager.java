 ...
 * resources managed by cached objects when those objects and OS resources are no longer needed (e.g. on application shutdown)
 * <p>
...
public final class SWTResourceManager {
   ...
   private static final Logger log                = LoggerFactory.getLogger(SWTResourceManager.class);
   ...
   public static void drawCenteredImage(PaintEvent event, Color backGroundColor, Image image) {
      ...
      // System.out.println("x=" + x + " y=" + y + " event.width=" + event.width + " event.height=" + event.height);
   ...
   public static Image getImage(Class<?> clazz, String imageName) {
      Image i = m_imageMap.get(imageName);
      if (i == null) {
      ...
      if (font == null) {
         ...
         if (strikeout || underline) {
            try {
               ...
               log.warn("Unable to set underline or strikeout (probably on a non-Windows platform). ", e); //$NON-NLS-1$ //$NON-NLS-2$
            }
         }
   ...
   ////////////////////////////////////////////////////////////////////////////
   /**
    * Dispose of cached objects and their underlying OS resources. This should only be called when the cached objects are no longer
    * needed (e.g. on application shutdown).
    */
   public static void dispose() {
      log.debug("dispose resources");
      disposeColors();
      disposeImages();
      disposeFonts();
      disposeCursors();
