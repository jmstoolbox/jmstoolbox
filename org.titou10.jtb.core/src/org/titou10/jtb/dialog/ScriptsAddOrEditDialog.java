 ...
 *
 */
public class ScriptsAddOrEditDialog extends MessageDialogAbstract {
   ...
   public ScriptsAddOrEditDialog(Shell parentShell, ConfigManager cm, JTBMessageTemplate template, String templateName) {
