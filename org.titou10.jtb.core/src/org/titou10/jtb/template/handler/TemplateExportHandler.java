...
/**
 * Manage the "Export Templates" directory config file command
 * 
...
public class TemplateExportHandler {
   ...
   public void execute(Shell shell) {
      ...
      fileDialog.setText("Select a file to export templates directories config file");
      ...
      try {
         templatesManager.exportTemplatesDirectoryConfig(templatesDirectoryConfigFileName);
         MessageDialog.openInformation(shell,
                                       "Export successful",
                                       "The templates directories config file has been successfully exported.");
      } catch (IOException | CoreException e) {
         jtbStatusReporter.showError("A problem occurred when exporting the templates directories config file", e, "");
         return;
      }
   }
