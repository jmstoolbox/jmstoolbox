...
/**
 * Manage the "Import Columns Sets" command
 * 
 * @author Denis Forveille
 * 
 */
public class ColumnsSetsImportHandler {
   private static final Logger log = LoggerFactory.getLogger(ColumnsSetsImportHandler.class);
   ...
   public void execute(Shell shell) {
      ...
      fileDialog.setText("Select columns sets file to import");
      ...
      try {
         ...
         jtbStatusReporter.showError("A problem occurred when importing the columns sets file", e, "");
         return;
      }
   }
