...
/**
 * Manage the "Message Export as Template" command
 * 
 * @author Denis Forveille
 * 
 */
public class MessageExportTemplateHandler {

   private static final Logger log = LoggerFactory.getLogger(MessageExportTemplateHandler.class);
   ...
   public void execute(Shell shell,
      ...
      try {
         TemplatesUtils.writeTemplateToOS(shell, jtbDestination.getName(), new JTBMessageTemplate(jtbMessage));
      } catch (Exception e) {
