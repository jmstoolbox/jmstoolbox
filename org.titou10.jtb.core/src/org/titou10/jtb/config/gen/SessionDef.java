 ...
 *       &lt;attribute name="promptCredentials" type="{http://www.w3.org/2001/XMLSchema}boolean" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "",
         propOrder = { "host", "port", "host2", "port2", "host3", "port3", "userid", "password", "destinationFilter",
...
public class SessionDef {
   ...
   @XmlAttribute(name = "promptCredentials")
   protected Boolean           promptCredentials;
   ...
   /**
    * Gets the value of the promptCredentials property.
    * 
   ...
   /**
    * Sets the value of the promptCredentials property.
    * 
    * @param value
