...
- Bugs fixed:
    -
- Other: 
    - Upgraded Apache Artemis 2.x jars to v2.53.0
...
- Bugs fixed:
    - Fixes #202: Replace variables in properties for  messages generated by scripts
    - Fixes #204: ActiveMQ: fixes CVE-2023-46604 by upgrading to v5.19.1
- Other: 
    - Upgraded Apache Artemis 2.x jars to v2.43.0
    - Upgraded Apache ActiveMQ jars to v5.19.1
    - Upgraded eclipse tycho to v5.0.1 (build system)
    - Upgraded eclipse RCP to v2025-12 (v4.38)
    - Upgraded JRE to v21.0.9
